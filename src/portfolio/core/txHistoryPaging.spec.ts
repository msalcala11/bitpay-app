...
describe('txHistoryPaging', () => {
  it('counts logical txs by unique normalized history ID within a page', () => {
    const txs = [
      {txid: 'fund', time: 1704067200, action: 'received', amount: '1000', fees: '0'},
      {txid: 'fund', time: 1704067200, action: 'received', amount: '1000', fees: '0'},
      {txid: 'spend', time: 1704153600, action: 'sent', amount: '400', fees: '10'},
    ];
  ...
  it('falls back to a composite ID when txid is missing', () => {
    const tx = {time: 1704067200, action: 'received', amount: '1000', fees: '0'};
